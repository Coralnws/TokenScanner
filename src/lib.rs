...
#[derive(Debug)]
pub struct TokenScannerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenScannerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenScanner processing");
    
    let mut processor = TokenScannerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenScannerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenScannerProcessor::new(false);
